const translations = {
    'pt': {
        ...
        /* --- NOVAS TRADUÇÕES DO ÍNDICE --- */
        'toc-title': "Índice",
        'toc-link-1': "O Resumo: Foco no 'Ultimate'",
        'toc-link-2': "A História em Três Partes",
        'toc-link-3': "Vamos Detalhar o 'Porquê'",
        'toc-link-4': "Teste Estatístico",
        'toc-link-5': "Conclusão Final da História",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- ADICIONE ESTA LINHA ---
    // Diz ao JavaScript para "escutar" por um clique no botão 
    // e, quando acontecer, executar a função scrollToTop.
    ...
    // O linter agora vê esta função sendo usada na linha "addEventListener"
